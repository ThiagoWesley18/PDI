...
#img = cv2.resize(img, (0,0), fx=0.5 , fy=0.5) # Redimensiona a imagem em 50%
...
# cv2.imwrite('nome_da_imagem.jpg', img) # Salva a imagem com o nome definido no primeiro parametro
